...
I do full-stack engineering for [Vested](https://vested.co) - helping startup employees exercise their options.<br/>
I self-host [Forgejo](https://forgejo.org/) these days 
...
Backend      Firebase · Redis · Socket.io · Stripe
Data         Firestore · MongoDB · Postgres 
Infra        Nix · Forgejo · MCPs
```
